...
class Institution(models.Model):
    ...
    short_name = models.CharField(max_length=10, blank=False, null=False, help_text=_("Institution's shortname according to https://en.wikipedia.org/wiki/List_of_universities_in_Malaysia"))
